    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            series: [
	                <%     
	                	out.print("{");            
	                	out.print(" name: '"+"Credit"+"', ");
	                	Map<Date,Double> map = NewOACreditSelling.getDailySellingMap(fTime,tTime);
	                	out.print("data: [");
	                	StringBuffer sb = new StringBuffer();
	                    for(int ii=dateList.size()-1;ii>=0;ii--){
	                    	if(map.containsKey(dateList.get(ii))){
	                     		sb.append(dfdouble.format(map.get(dateList.get(ii))));
	                     		sb.append(",");
	                    	}else{
	                    		sb.append("0");
	                     		sb.append(",");
...
*/	
	...
	ArrayList<String> itemList = NewOACreditSelling.getItemList(fTime,tTime);
	...
	Map<String,Integer> oneDateMap = new HashMap<String,Integer>();
	
	for(int i=0;i<dateList.size();i++){
		out.print("<tr>");
		oneDateMap = NewOACreditSelling.getOneDateMap(dateList.get(i));
		...
		out.print("<td>");
		if(map.containsKey(dateList.get(i))){
			out.print(dfdouble.format(map.get(dateList.get(i))));
		}else{
			out.print(" ");
		}
		out.print("</td>");
