...
<%
	...
	DBResultSet ds=DBUtil.db.execSQL("select weaponlevel,users,count,succount,maxusercount,maxuserid,sapphirecount,sapphireuser,dtime from reinforcecalc_new where weaponlevel != 'ALL' and dtime = ? and type = ? order by weaponlevel", new Object[]{startTime,type});
