		...
		if(session!=null&&session.getAttribute("login")!=null){
				...
				if(request.getParameter("time")!=null){
					...
					Date fromTime = OAStatUtil.convertDate(request
							.getParameter("time"));
					java.util.Map<Integer,Integer> tid = new java.util.HashMap<Integer, Integer>();
					java.util.Map<Integer,Integer> contribution = new java.util.HashMap<Integer, Integer>();
					tid = Stocks.getTribeId(fromTime);
					contribution = Stocks.getContributin(fromTime);
