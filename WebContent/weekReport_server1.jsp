...
<%
	...
	DBResultSet ds=DBUtil.db.execSQL("select * from weekReport where dtime in(select top 4 * from (select distinct dtime from weekReport) y order by dtime desc) and server = 'Server1' order by dtime desc", new Object[]{});
