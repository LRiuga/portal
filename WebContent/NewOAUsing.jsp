    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            series: [
	                <%     
	                	out.print("{");            
	                	out.print(" name: '"+"Using"+"', ");
	                	Map<Date,Integer> map = NewOAUsing.getDailyUsingMap(fTime,tTime);
	                	out.print("data: [");
	                	StringBuffer sb = new StringBuffer();
...
if(!map.isEmpty()){
	...
	ArrayList<String> itemList = NewOAUsing.getItemList(fTime,tTime);
	...
	for(int i=0;i<dateList.size();i++){
		out.print("<tr>");
		oneDateMap = NewOAUsing.getOneDateMap(dateList.get(i));
		...
		if(map.containsKey(dateList.get(i))){
			out.print(map.get(dateList.get(i)));
		}else{
			out.print(" ");
		}
		out.print("</td>");
