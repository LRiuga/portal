	...
	<%
		if(session!=null&&session.getAttribute("login")!=null){
			...
			if(monetid!=null&&ftime!=null&&ttime!=null){
				...
				ArrayList<String> itemList = UserInfo.GetUseItemList(monetid,fromTime,toTime);
				ArrayList<Date> timeList = UserInfo.GetUseTimeList(monetid,fromTime,toTime);
				...
				out.print("</th>");
				out.print("<th>");
				out.print(enType.getString("message"));
				out.print("</th>");
				out.print("<th>");
