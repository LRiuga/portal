...
<%
	...
	try{
		...
		DBResultSet ds=DBUtil.db.execSQL("select monetid,oakey,oavalue from arenaTop100Detail where arenaid = 2  and dtime = ? order by position", new Object[]{startTime});
...
<h1>竞技场前100 竞技场2 <%out.print(startTime); %></h1>
<h3>可选</h3>
